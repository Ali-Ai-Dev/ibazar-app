...
/**
 * Created by Omid on 4/8/2018.
 */

public class MyRecyclerView extends RecyclerView {

    private final static int MINIMUM_SCROLL_EVENT_OFFSET_MS = 20;
    public static LinearLayoutManager linearLayoutManagerSnap;
    Context context;
    ...
    public void setOrientation(Orientation orientation) {
        ...
        linearLayoutManagerSnap = new LinearLayoutManager(getContext(), _orientation.intValue(), false);
        setLayoutManager(linearLayoutManagerSnap);
    }
        ...
        if (!_userScrolling) {
            if (event.getAction() == MotionEvent.ACTION_UP) {
                if (targetView != getCenterView()) {
                    ...
                    Act_Main mAct = (Act_Main) context;
                    mAct.setCategoryByPosition(position);
